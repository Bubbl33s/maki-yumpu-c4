...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=BUBBLES;Initial Catalog=MakiYumpuSAC;TrustServerCertificate=True; User ID=sa;Password=1234;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DetalleFormPedido>(entity =>
        {
            ...
            entity.HasOne(d => d.IdFormPedidoNavigation).WithMany()
        ...
        modelBuilder.Entity<DetalleFt>(entity =>
        {
            ...
            entity.HasOne(d => d.IdFichaTecnicaNavigation).WithMany()
                .HasForeignKey(d => d.IdFichaTecnica)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__DETALLE_F__id_fi__4BAC3F29");

            entity.HasOne(d => d.IdMaterialNavigation).WithMany()
                .HasForeignKey(d => d.IdMaterial)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__DETALLE_F__id_ma__4CA06362");
        });
        ...
        {
            entity.HasKey(e => new { e.IdFichaTecnica, e.IdPedido }).HasName("PK__DETALLE___101DE5FBC6C59DE7");
            ...
            entity.HasOne(d => d.IdFichaTecnicaNavigation).WithMany(p => p.DetallePedidos)
                .HasForeignKey(d => d.IdFichaTecnica)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__DETALLE_P__id_fi__5165187F");

            entity.HasOne(d => d.IdPedidoNavigation).WithMany(p => p.DetallePedidos)
                .HasForeignKey(d => d.IdPedido)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__DETALLE_P__id_pe__52593CB8");
        });
        ...
        modelBuilder.Entity<ImgFichaTecnica>(entity =>
        {
            ...
            entity.HasOne(d => d.IdFichaTecnicaNavigation).WithMany()
                .HasForeignKey(d => d.IdFichaTecnica)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__IMG_FICHA__id_fi__4E88ABD4");
        });
        ...
        modelBuilder.Entity<ImgFormPedido>(entity =>
        {
            ...
            entity.HasOne(d => d.IdFormPedidoNavigation).WithMany()
                .HasForeignKey(d => d.IdFormPedido)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__IMG_FORM___id_fo__5812160E");
        });
